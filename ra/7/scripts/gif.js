...
/***/ function(module, exports, __webpack_require__) {
	...
	AFRAME.registerShader('gif', {
	  ...
	  nextFrame: function nextFrame(posFrame) {
		this.__draw(posFrame);
	   ...
	   * @private
	   */
	  __draw: function __draw(ind) {
	    
		 /* this.__clearCanvas(); 
		 this.__ctx.drawImage(this.__frames[this.__frameIdx], 0, 0, this.__width, this.__height); this.__texture.needsUpdate = true; */
		 this.__clearCanvas(); 
		 this.__ctx.drawImage(this.__frames[ind], 0, 0, this.__width, this.__height); this.__texture.needsUpdate = true;
	  },
